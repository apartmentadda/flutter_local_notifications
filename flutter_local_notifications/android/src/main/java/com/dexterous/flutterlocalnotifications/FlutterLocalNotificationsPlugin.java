...
public class FlutterLocalNotificationsPlugin
  ...
  static final int NOTIFICATION_PERMISSION_REQUEST_CODE = 91;

  static final int EXACT_ALARM_PERMISSION_REQUEST_CODE = 92;

  static final int FULL_SCREEN_INTENT_PERMISSION_REQUEST_CODE = 93;
  static final int NOTIFICATION_POLICY_ACCESS_REQUEST_CODE = 94;
